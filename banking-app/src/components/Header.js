...
<span className="ml-3 text-2xl font-semibold">Our Premier Banking</span> {/* Updated Brand Name with new style */}
          <span className="ml-3 text-xl font-bold">Not My Bank</span> {/* Updated Brand Name */}
